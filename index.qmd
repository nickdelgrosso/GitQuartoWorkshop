...
## Exercise 1: Add your Project to the Repo

1. Clone the Repo to Your Local Machine.
2. Create a folder in `projects/` called "YourName_ProjectName"
3. In your project folder, create a `README.md` file and describe your project, making a commit and pushing the changes each time your make changes.
...
## Exercise 2: Practice Branching and Pull Requests

**Note:** The `main` branch is now protected - you cannot push directly to it!

1. Create a new branch locally
2. Make changes to your project's `readme.md` file
3. Commit your changes
4. Push your branch to the remote
5. Go to GitHub and create a Pull Request from your branch to `main`
6. Find a partner sitting next to you
7. Review and merge your partner's Pull Request
8. Have them merge yours!

# Unit 2: Quarto Presentations with RevealJS
...
# Unit 3: Quarto: Putting Dynamic Code in Your Documents
...
1. Rename your `README.md` file to `index.qmd`
